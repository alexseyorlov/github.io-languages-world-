...
> Интерактивный веб-проект для визуализации данных о распределении говорящих на топ-15 языках мира по континентам. **Это учебный проект для тренировки веб-кодинга.**
